class Departement {
  ...
  constructor(private id: string, public name: string) { // In this case, we try to use shorthand Initialization. In this case, we don't need to declare the property id and name, and then assign the value of the parameter id and name to the property id and name. We can use shorthand Initialization, and we can declare the property id and name in the constructor parameter. In this case, we use private access modifier in the parameter id, so we can't access the property id from outside the class. And we use public access modifier in the parameter name, so we can access the property name from outside the class. And then we assign the value of the parameter id and name to the property id and name. So, we don't need to declare the property id and name, and then assign the value of the parameter id and name to the property id and name. We can use shorthand Initialization, and we can declare the property id and name in the constructor parameter.
  }
